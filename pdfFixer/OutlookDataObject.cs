...
namespace pdfFixer
{
    ...
    public class OutlookDataObject : System.Windows.Forms.IDataObject
    {
        ...
        /// <summary>
        /// Holds the <see cref="MethodInfo"/> of the "GetDataFromHGLOBAL" method of the internal ole <see cref="System.Windows.Forms.IDataObject"/>.
        /// </summary>
            ...
            switch (format)
            {
                case "FileGroupDescriptor":
                    ...
                    try
                    {
                        ...
                        //marshal the unmanaged memory to FILEGROUPDESCRIPTORA struct
                        ...
                        IntPtr fileDescriptorPointer = IntPtr.Add(fileGroupDescriptorAPointer, Marshal.SizeOf(fileGroupDescriptor.cItems));
            ...
            switch (medium.tymed)
            {
                case TYMED.TYMED_ISTORAGE:
                    ...
                    try
                    {
                        ...
                        long iLockBytesSize = iLockBytesStat.cbSize;
                ...
                case TYMED.TYMED_ISTREAM:
                    ...
                    try
                    {
                        ...
                        long iStreamSize = iStreamStat.cbSize;
